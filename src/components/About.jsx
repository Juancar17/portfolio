...
function About() {
  ...
  return (
    <Container id="about" className="my-4 about-section">
      <Row className="align-items-center">
        {/* Columna de Texto */}
        <Col md={6} className="about-text">
          <h2 className="mb-4 align-items-center">¡Hola!</h2>
          <p>
            <span id="nameInitial"> Soy Juan Carlos</span>
          </p>
          <p>
            ...
            contribuir con mis conocimientos y seguir aprendiendo. Me apasiona
            trabajar en proyectos innovadores que integren{" "}
        ...
        {/* Columna de Imagen */}
        <Col md={6} className="text-center about-image my-4">
          <img
            src={logo1}
